...
<head>
    ...
    <title>Blog's Admin (Add Posts)</title>
</head>
<body>
...
<div class="button-group">
    ...
    <h2 class="page-title">إضافة المنشورات</h2>

        <?php include(ROOT_PATH . '/app/helpers/formErrors.php'); ?>

    <form action="create.php" method="post" class="edit" enctype="multipart/form-data">
        <div>
            <label>العنوان</label>
        ...
        <label>العرض</label>
           ...
           <input type="file" name="image" class="tex-inputt"></div>
            ...
            <div>
                <button type="submit" name="add-post" class="btn btn-big">حفظ المنشور</button>
            </div>
        </form>
        </div>
