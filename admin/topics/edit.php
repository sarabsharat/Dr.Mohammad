...
<head>
    ...
    <title>Blog's Admin (edit topic)</title>
</head>
<body>
...
<a href="create.php" class="btn btn-big">إضافة موضوع</a>
    ...
    <h2 class="page-title">تعديل المواضيع</h2>
    ...
    <input type="hidden" name="name" value="<?php echo $id; ?>">
        ...
        <div>
        <label>الوصف</label>
             <textarea type="text" name="description" id="body" class="text-inputt"><?php echo $description; ?></textarea>
</div>
            
            <div>
                <button type="submit" name="update-topic"class="btn btn-big">تعديل الموضوع</button>
            </div>
        </form>
        </div>
